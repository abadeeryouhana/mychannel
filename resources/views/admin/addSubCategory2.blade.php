    ...
    <div class="container" style="margin-top:100px">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4>Add Sub-Category-2 ( <span class="text-danger">*</span><span style="font-size: 14px">required</span> )</h4>
                        <hr />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route( 'subcategory2.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
